    ...
    cards: [
      ...
      },
      {
        ...
        slots: [
          {
            id: 0,
            options: ["scanf", "printf", "print", "write"],
            correct: 1,
            fixed: false,
          },
          { id: 1, options: ['("Hello, World!")'], correct: 0, fixed: true },
          { id: 2, options: [":", ";", ",", "."], correct: 1, fixed: false },
        ],
    ...
    cards: [
      ...
      },
      {
        ...
        slots: [
          ...
          { id: 2, options: ["+", "=", "-", "*"], correct: 1, fixed: false },
          { id: 3, options: ["15.5", "15", "'A'", "hello"], correct: 1, fixed: false },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        slots: [
          { id: 0, options: ["while", "for"], correct: 1, fixed: false },
          { id: 1, options: ["("], correct: 0, fixed: true },
          {
            id: 2,
            options: ["int i=1", "int i=0", "i=0", "int i=-1"],
            correct: 1,
            fixed: false,
          },
